...
double poly_A1B3_deg5_v1::eval(const double x[6],
    ...
    return((t1+(t2+(t3+(t4*t5+t6)*t5)*t5)*t5)*t5+(t1+t25+(t2+t32+(t3+t34+(t4*t24+t18+t6)*t24)*t24)*t24)*t24+(t1+t25+(t15+(a[21]+(t46+t47)*t5)*t5+(t16+t55+(
...
t412+(t424+t274+t259)*t24+(t249*t64+t251+t258+t421)*t64)*t64+(a[14]+(t459*t5+

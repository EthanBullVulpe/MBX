...
void GetC6(std::string mon_id1, std::string mon_id2, size_t index1, size_t index2, double& out_C6, double& out_d6) {
    ...
    if (mon_id1 == "h2o" && mon_id2 == "h2o") {
        ...
        // Fill in (in order) the C6 and d6 coefficients
        C6.push_back(243.9349);  // kcal/mol * A^(-6)  A--A
        C6.push_back(98.7333);  // kcal/mol * A^(-6)  A--B
        C6.push_back(98.7333);  // kcal/mol * A^(-6)  A--B
        C6.push_back(40.0503);  // kcal/mol * A^(-6)  B--B
        d6.push_back(0.0);  // A^(-1) A--A
        d6.push_back(0.0);  // A^(-1) A--B
        d6.push_back(0.0);  // A^(-1) A--B
        d6.push_back(0.0);  // A^(-1) B--B
